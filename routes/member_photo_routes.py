...
# def create_member_photo(member_photo: MemberPhotoCreate) -> dict[str, str]:
#     """創建會員照片"""
#     result = MemberPhoto.create_member_photo(**member_photo.model_dump())
#     if "error" in result:
#         # 如果是重複會員照片的錯誤，返回 400 狀態碼
#         if "會員照片已存在" in result["error"]:
